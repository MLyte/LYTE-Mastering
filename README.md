...
Le mode **Auto — Hard Techno** vise un niveau de sortie mesuré entre **−9 et −2 LUFS** (−5 LUFS par défaut). Le bouton « Use integrated Hard Techno level » sélectionne −2,9 LUFS. Il rend trois masters à la même cible : **Fidèle** (intensité 0,65, grave préservé, sans soft clip), **Dense** (0,85, grave préservé, soft clip 0,5 dB) et **Agressif** (1,00, grave dynamique, soft clip 1 dB). Chaque profil peut recalibrer la consigne de PhaseLimiter jusqu’à trois fois pour se rapprocher de ±0,3 LUFS ; si cela échoue, LYTE conserve son résultat le plus proche et explique l’écart.

Le grave dynamique utilise un crossover complémentaire à 150 Hz pour éviter une annulation à la recombinaison. Les intermédiaires de finition restent en virgule flottante. Après cette finition, une calibration du gain avec écrêtage doux suréchantillonné ×4 lorsque les crêtes le nécessitent, puis limiteur à anticipation mesure chaque sortie PCM 24 bits, corrige son true peak puis ajuste le gain vers la cible (huit essais au maximum, toujours depuis le même intermédiaire). Une cible impossible à atteindre reste signalée dans les diagnostics. Le true peak final reste plafonné à −1 dBTP. Les différences de facteur de crête et de grave deviennent des compromis affichés par profil ; elles ne font plus disparaître un master dense. Chaque rendu est aussi encodé localement en AAC 256 kbit/s puis remesuré. Un dépassement AAC est signalé comme risque de diffusion, sans masquer le fichier.
